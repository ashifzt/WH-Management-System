...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                <td class="auto-style3">Vendor Invoice Number</td>
            ...
            <tr>
                <td class="auto-style3">Vendor Invoice Date</td>
                <td class="auto-style4">
            ...
            <tr>
                <td class="auto-style3">Invoice Value</td>
                <td class="auto-style4">
            ...
            <tr>
                <td class="auto-style3">Vehicle Number</td>
                <td class="auto-style4">
