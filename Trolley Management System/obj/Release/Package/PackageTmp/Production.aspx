...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <div style="margin-top:10px">
            Scan Material :
        <asp:TextBox ID="TextBox1" runat="server" Width="130px" AutoPostBack="true"></asp:TextBox>
            &nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label12" runat="server" Text="Label"></asp:Label>
        </div>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style17">
                    ...
                    Qty&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
        <asp:TextBox ID="TextBox12" runat="server" Width="130px" AutoPostBack="true"></asp:TextBox>
       &nbsp;
                    <asp:Button ID="Button1" runat="server" Text="Get Details" Width="136px" />
